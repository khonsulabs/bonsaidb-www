...
"connections" using the non-async interface. The overhead is very low, but it is
...
In the above chart, the two values that dip in the middle use [`BonsaiEpoch`][bonsai-epoch]. After considering that databases either live long enough to be used for almost an eternity (PostgreSQL was first released in the 1980s) or live a short life. I thought the 10-year anniversary of the first commit of BonsaiDb seemed like a good idea.
...
[has-session]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/connection/trait.HasSession.html
[session]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/connection/struct.Session.html
...
[authenticated-permissions]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/local/config/struct.StorageConfiguration.html#structfield.authenticated_permissions
[key-guide]: https://dev.bonsaidb.io/release/guide/traits/key.html
[key-trait]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/trait.Key.html
[key-encoding-trait]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/trait.KeyEncoding.html
[discord]: https://discord.khonsulabs.com/
[lrd]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/time/limited/struct.LimitedResolutionDuration.html
[lrt]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/time/limited/struct.LimitedResolutionTimestamp.html
[bonsai-epoch]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/time/limited/struct.BonsaiEpoch.html
[time-types]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/time/index.html#types
[time-resolution]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/time/limited/trait.TimeResolution.html
[time-epoch]: https://dev.bonsaidb.io/v0.4.0/docs/bonsaidb/core/key/time/limited/trait.TimeEpoch.html
